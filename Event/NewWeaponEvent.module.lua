...
-- Original: ReplicatedStorage.Config.Event.NewWeaponEvent
...
local t = {
	Weapon = "DSR1",
	Timeout = DateTime.fromUniversalTime(2026, 5, 25).UnixTimestamp,
	Product = Constant.Product.NewWeaponEvent_Skip,
	Quest2Spent = {
		Coin = 60000,
		TradeToken = 10000
	},
